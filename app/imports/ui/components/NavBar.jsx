      ...
      <nav className="navbar navbar-light bg-white shadow py-3 sticky-top navbar-top">
        ...
        {this.props.currentUser ? ([
          <div className={'nav-collapse'}>
            <ul key={3} className="nav">
              <li className="navbar-side-item" data-toggle="collapse" data-target=".navbar-collapse.show">
                <div className="row">
                  <div className="col-3 text-right">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-person" viewBox="0 0 16 16" color="#5f5f5f">
                      <path
                        d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6
              4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                    </svg>
                  </div>
              ...
              <li className="navbar-side-item">
                <div className="row">
                  ...
                  <div className="col-9 px-0 text-left">
                    <Link to="/signout" className="side-link">Sign Out</Link>
                  </div>
                </div>
              </li>
            </ul>
